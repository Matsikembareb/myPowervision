...
class CustomerForm(FlaskForm):
    ...
    customer_number = StringField('Customer ID', validators=[Length(min=1, max=20)])
    ...
    billing_address = StringField('Billing Address', validators=[Length(max=256)])
    notes = TextAreaField('Notes', validators=[Length(max=512)])
    submit = SubmitField('Submit')
