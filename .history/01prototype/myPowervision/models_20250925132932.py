...
class Staff(db.Model):
    ...
    # Relationship mapping
    department: so.WriteOnlyMapped[Optional[Department]]= so.relationship(back_populates='staff')
...
class Department(db.Model):
    ...
    # Relationship mapping
    staff: so.Mapped[Optional[Staff]]= so.relationship(back_populates='department')
