...
class JobForm(FlaskForm):
    ...
    created_at = DateTimeLocalField('Created Date', validators=[Optional()], format='%Y-%m-%dT%H:%M')
    date_scheduled = DateTimeLocalField('Scheduled Date & Time', validators=[Optional()], format='%Y-%m-%dT%H:%M')
