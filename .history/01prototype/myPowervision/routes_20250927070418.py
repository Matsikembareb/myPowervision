...
def permissionManagement():
    ...
    return render_template('user_management/permissions.html', title='Permission Management', active='permissions', permissions=permissions, roles=roles, rolepermissions=rolepermissions)
