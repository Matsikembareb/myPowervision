...
class VehicleForm(FlaskForm):
    vehicle_number = StringField('Vehicle Number', validators=[DataRequired(), Length(min=1, max=20)])
    ...
    def validate_vehicle_number(self, vehicle_number):
        ...
        if vehicle is not None and (self.vehicle_id is None or vehicle.vehicleid != self.vehicle_id):
