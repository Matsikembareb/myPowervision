...
def create_default_data():
    ...
    if db.session.scalar(sa.select(sa.func.count(Staff.id))) == 0:
        ...
        print("Default departments, IT Attachee position, and developer staff created!")
