    ...
    if request.method == 'POST':
        ...
        if email == '' or password == '':
            ...
            if user:
                ...
                new_user = User.query.filter_by(email=email).update(dict(password=hashed_password))
                db.session.commit()
...
def userUpdateProfile():
    return render_template("auth/user/update_profile.html", title="Update Profile")
