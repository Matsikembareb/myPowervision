...
class Job(db.Model):
    ...
    assigned_to: so.Mapped[Optional['User']] = so.relationship(back_populates='assigned_jobs')
    created_by: so.Mapped[Optional['User']] = so.relationship(back_populates='created_jobs')
