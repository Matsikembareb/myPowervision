...
class Staff(db.Model):
    ...
    # Relationship mapping
    department: so.WriteOnlyMapped[Optional[Department]]= so.relationship(back_populates='worker')
...
class Department(db.Model):
    ...
    # Relationship mapping
    worker: so.Mapped[Optional[Staff]]= so.relationship(back_populates='department')
